...
class CommunicationButtons extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> _sendWhatsApp() async {
      ...
      String phoneNumber = property.whatsapp.trim().replaceAll(RegExp(r'\s+|-'), '');
      ...
      final Uri url = Uri.parse('https://api.whatsapp.com/send?phone=$phoneNumber');
    ...
    Future<void> _sendEmail() async {
      ...
      final String subject = Uri.encodeComponent('استفسار عن عقار: ${property.title}');
