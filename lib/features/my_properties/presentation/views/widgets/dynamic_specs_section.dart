...
class DynamicSpecsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (selectedPropertyType == PropertyType.workshops) {
              ...
              child: Column(
                children: [
                  ...
                  CustomTextFormField(
                    ...
                    suffixText:
                        workshopHeightNode.hasFocus ||
                            workshopHeightController.text.isNotEmpty
                        ? 'متر'
                        : null,
                  ),
                ],
              ...
              child: Column(
                children: [
                  CustomTextFormField(
                    ...
                    keyboardType: TextInputType.number,
                    suffixText:
                        hallCapacityNode.hasFocus ||
                            hallCapacityController.text.isNotEmpty
                        ? 'شخص'
                        : null,
                  ),
                ],
              ...
              child: Column(
                children: [
                  CustomTextFormField(
                    ...
                    keyboardType: TextInputType.number,
                    suffixText:
                        warehouseHeightNode.hasFocus ||
                            warehouseHeightController.text.isNotEmpty
                        ? 'متر'
                        : null,
                  ),
                  const SizedBox(height: 16),
          ...
          Card(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  CustomTextFormField(
                    controller: examinationRoomsController,
                    textAlign: TextAlign.right,
                    labelText: 'عدد غرف الكشف',
                  ...
                  CustomTextFormField(
                    ...
                    textAlign: TextAlign.right,
                    labelText: 'التجهيزات الطبية المتوفرة',
                    prefixIcon: Icons.medication_liquid_outlined,
                    hintText: 'اذكر الأجهزة والمعدات المتوفرة',
                    maxLines: 3,
                  ),
                ],
              ),
              ...
              child: Column(
                children: [
                  ...
                  CustomTextFormField(
                    ...
                    keyboardType: TextInputType.number,
                    suffixText:
                        areaNode.hasFocus || areaController.text.isNotEmpty
                        ? 'م²'
                        : null,
                  ),
                  const SizedBox(height: 16),
                  ...
                  CustomTextFormField(
                    ...
                    textAlign: TextAlign.right,
                    labelText: 'أنواع الأشجار/المحاصيل',
                    prefixIcon: Icons.park_outlined,
                    hintText: 'مثل: زيتون، حمضيات، خضروات',
                  ),
                ],
              ),
            ),
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 16),
                  CustomTextFormField(
                    controller: frontagesController,
                    textAlign: TextAlign.right,
                    labelText: 'عدد الواجهات',
                  ...
                  CustomTextFormField(
                    ...
                    textAlign: TextAlign.right,
                    labelText: 'عرض الشارع',
                    prefixIcon: Icons.polyline_outlined,
                    keyboardType: TextInputType.number,
                    suffixText:
                        streetWidthNode.hasFocus ||
                            streetWidthController.text.isNotEmpty
                        ? 'متر'
                        : null,
                  ),
                ],
      ...
      String header = selectedPropertyType == PropertyType.shops
          ? 'مواصفات محلات'
          : 'مواصفات محلات في مراكز تجارية';
      return Column(
        children: [
          ...
          Card(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  CustomTextFormField(
                    controller: frontageWidthController,
                    focusNode: frontageNode,
                    textAlign: TextAlign.right,
                    labelText: 'عرض الواجهة',
                    prefixIcon: Icons.store_outlined,
                    keyboardType: TextInputType.number,
                    suffixText:
                        frontageNode.hasFocus ||
                            frontageWidthController.text.isNotEmpty
                        ? 'م'
                        : null,
                  ),
                  const SizedBox(height: 16),
                  ...
                  CustomTextFormField(
                    ...
                    textAlign: TextAlign.right,
                    labelText: 'النشاط التجاري المسموح',
                    prefixIcon: Icons.business_outlined,
                    hintText: 'مثل: تجاري، مطعم، صيدلية، إلخ',
                    maxLines: 2,
                  ),
                ],
              ),
              ...
              child: Column(
                children: [
                  ...
                  CustomTextFormField(
                    ...
                    textAlign: TextAlign.right,
                    labelText: 'مساحة البناء',
                    prefixIcon: Icons.home_outlined,
                    keyboardType: TextInputType.number,
                    suffixText:
                        buildingAreaNode.hasFocus ||
                            buildingAreaController.text.isNotEmpty
                        ? 'م²'
                        : null,
                  ),
                  const SizedBox(height: 16),
    ...
    } else if (selectedPropertyType == PropertyType.buildings ||
        selectedPropertyType == PropertyType.housesAndApartments ||
        selectedPropertyType == PropertyType.underConstruction) {
      String header = selectedPropertyType == PropertyType.buildings
          ? 'مواصفات مباني'
          : 'مواصفات المنازل والشقق';
      return Column(
        children: [
              ...
              child: Column(
                children: [
                  ...
                  CustomTextFormField(
                    ...
                    labelText: 'رقم الطابق',
                    prefixIcon: Icons.layers_outlined,
                    hintText: '0 للطابق الأرضي',
                  ),
                  const SizedBox(height: 16),
                  CustomTextFormField(
                    controller: totalFloorsController,
                    textAlign: TextAlign.right,
                    labelText: 'عدد طوابق البناء',
