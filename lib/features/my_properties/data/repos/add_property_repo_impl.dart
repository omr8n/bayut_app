...
class AddPropertyRepoImpl implements AddPropertyRepo {
  ...
  Future<Either<Failure, String>> addProperty(PropertyEntity property) async {
    try {
      // 🔥 الحل الجذري: نستخدم المعرف الموجود في العقار مباشرة
      // إذا كان "تعديل" سيبقى نفس المعرف القديم ولن يضاف عنصر جديد
      final productModel = PropertyModel.fromEntity(property);
