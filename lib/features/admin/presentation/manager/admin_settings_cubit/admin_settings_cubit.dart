...
//     result.fold((failure) => emit(AdminSettingsFailure(failure.message)), (
//       settings,
//     ) {
...
//     result.fold((failure) => emit(AdminSettingsFailure(failure.message)), (_) {
//       if (actionKey != null) {
//         operationLogger.logAdminAction(actionKey, {
